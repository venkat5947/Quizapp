...
class DataSource
{
     ...
     * @return int
     */
    public function add_question($topic, $subject, $discription, $opt_a, $opt_b, $opt_c, $opt_d, $correct_ans, $explanation, $difficulty="medium",$opt_e="NULL"){
        try{
            // echo "in add_question".$_SESSION['user_id'];
    ...
    public function insert($query, $paramType, $paramArray)
    {
        ...
        return $insertId;
            ...
            echo "There is a Question Repeated";
        }
    }
